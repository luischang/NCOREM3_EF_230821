...
using NCOREM4_MVCEF.DatabaseFirst.Models;

namespace NCOREM4_MVCEF.DatabaseFirst.Controllers
{
    public class PlayersController : Controller
    {
        private readonly MundialDB250821Context _context;

        public PlayersController(MundialDB250821Context context)
        {
            _context = context;
        }
        ...
        {
            var mundialDB250821Context = _context.Player.Include(p => p.SoccerPosition);
            return View(await mundialDB250821Context.ToListAsync());
        }
